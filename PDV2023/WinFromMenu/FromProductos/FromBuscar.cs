...
namespace WinFromMenu
{
    public partial class FromBuscar : Form
    {
        ...
        //Método para enviarnos la información del producto al picutre box (es lo que me interesa). 
        ...
        //Con esto cerraremos nuestro formulario. 
        private void pictureBoxClose_Click(object sender, EventArgs e)
        {
            this.Close();
        }
        //Al cargar el formulario nos cargará los productos ya existentes (aún podemos seleccionar nuevos) 
        private void FromBuscar_Load(object sender, EventArgs e)
        {
            this.cargarDatos();
        }
